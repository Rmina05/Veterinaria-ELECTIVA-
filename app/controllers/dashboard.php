...
if($usuario['rol'] == 'administrador') {
    ...
    $stmt->execute();
    $datos['total_usuarios'] = $stmt->fetch()['total'];
    
    $stmt = $db->prepare("SELECT COUNT(*) as total FROM clientes WHERE estado = 'activo'");
    $stmt->execute();
    $datos['total_clientes'] = $stmt->fetch()['total'];
    
    $stmt = $db->prepare("SELECT COUNT(*) as total FROM citas WHERE estado = 'programada'");
    $stmt->execute();
    $datos['citas_programadas'] = $stmt->fetch()['total'];
}
?>
...
<title>Dashboard - Lugo Vet</title>
...
<div class="container">
    <div class="welcome">
        ...
        <p>Rol: <strong><?= ucfirst($usuario['rol']) ?></strong></p>
    </div>
    ...
    <div class="menu">
        <?php if(Rol::tienePermiso($usuario['rol'], 'ver_usuarios')): ?>
        <div class="menu-item">
        ...
        <div class="menu-item">
            ...
            <a href="gestionar_citas.php">Citas</a>
        </div>
        <?php endif; ?>
        ...
        <div class="menu-item">
            ...
            <a href="gestionar_mascotas.php">Mascotas</a>
        </div>
        <?php endif; ?>

        <?php if(Rol::tienePermiso($usuario['rol'], 'ver_reportes')): ?>
        <div class="menu-item">
        ...
        <div class="menu-item">
            ...
            <a href="gestionar_servicios.php">Servicios</a>
        </div>
        <?php endif; ?>
        ...
        <div class="menu-item">
            ...
            <a href="gestionar_veterinarios.php">Veterinarios</a>
        </div>
        <?php endif; ?>
